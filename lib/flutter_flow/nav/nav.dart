...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => appStateNotifier.showSplashImage
          ? Builder(
              builder: (context) => Container(
                ...
                child: Image.asset(
                  'assets/images/parsi-app-logo-512.png',
                  fit: BoxFit.contain,
                ),
              ),
            )
      ...
      routes: [
        ...
        FFRoute(
          name: DirectoryWidget.routeName,
          path: DirectoryWidget.routePath,
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Listings')
              : ListingsWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: AddWidget.routeName,
          path: AddWidget.routePath,
          builder: (context, params) =>
